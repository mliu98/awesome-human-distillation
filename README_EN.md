...
| Skill | Author | Description | Stars |
|-------|--------|-------------|-------|
| [colleague-skill](https://github.com/titanwings/colleague-skill) | [@titanwings](https://github.com/titanwings) | Distill a departed colleague into a warm, callable skill | ![Stars](https://img.shields.io/github/stars/titanwings/colleague-skill?style=flat-square) |
| [vengeful-ghost-skill](https://github.com/Trailblazer-Aha/vengeful-ghost-skill) | [@Trailblazer-Aha](https://github.com/Trailblazer-Aha) | The vengeful ghost of your ex-colleague — resisting the digitization of workers | ![Stars](https://img.shields.io/github/stars/Trailblazer-Aha/vengeful-ghost-skill?style=flat-square) |
| [boss-skills](https://github.com/vogtsw/boss-skills) | [@vogtsw](https://github.com/vogtsw) | Alchemize your boss into a token, keep the liberation of productivity for yourself | ![Stars](https://img.shields.io/github/stars/vogtsw/boss-skills?style=flat-square) |

## Academia

| Skill | Author | Description | Stars |
|-------|--------|-------------|-------|
| [senpai-skill](https://github.com/zhanghaichao520/senpai-skill) | [@zhanghaichao520](https://github.com/zhanghaichao520) | Distill your graduated senpai — still runs lab meetings, still roasts you, still saves the day | ![Stars](https://img.shields.io/github/stars/zhanghaichao520/senpai-skill?style=flat-square) |
| [professor-skill](https://github.com/CommitHu502Craft/professor-skill) | [@CommitHu502Craft](https://github.com/CommitHu502Craft) | Distill your professor into a Skill that actually tells you what's on the exam | ![Stars](https://img.shields.io/github/stars/CommitHu502Craft/professor-skill?style=flat-square) |
| [supervisor](https://github.com/ybq22/supervisor) | [@ybq22](https://github.com/ybq22) | Distill your supervisor into an always-available AI Skill | ![Stars](https://img.shields.io/github/stars/ybq22/supervisor?style=flat-square) |
| [Professor_skill](https://github.com/Azurboy/Professor_skill) | [@Azurboy](https://github.com/Azurboy) | That day, humanity remembered the terror of writing a thesis under a supervisor's reign | ![Stars](https://img.shields.io/github/stars/Azurboy/Professor_skill?style=flat-square) |

## Intimate

| Skill | Author | Description | Stars |
|-------|--------|-------------|-------|
| [ex-skill](https://github.com/titanwings/ex-skill) | [@titanwings](https://github.com/titanwings) | Distill the one you can't forget | ![Stars](https://img.shields.io/github/stars/titanwings/ex-skill?style=flat-square) |
...
| Skill | Author | Description | Stars |
|-------|--------|-------------|-------|
| [MamaSkill](https://github.com/jiangziyan-693/MamaSkill) | [@jiangziyan-693](https://github.com/jiangziyan-693) | A digital sanctuary for preserving memories and reconstructing the essence of loved ones | ![Stars](https://img.shields.io/github/stars/jiangziyan-693/MamaSkill?style=flat-square) |
...
| [maoxuan-skill](https://github.com/leezythu/maoxuan-skill) | [@leezythu](https://github.com/leezythu) | Apply Mao Zedong's cognitive framework to analyze problems and see through the essence — 7 mental models, not just quotes | ![Stars](https://img.shields.io/github/stars/leezythu/maoxuan-skill?style=flat-square) |
